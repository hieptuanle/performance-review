...
const criteria = [
  ...
  },
  {
    ...
    definition:
      "Phản hồi công việc là việc chia sẻ nhận thức của mọi người về hành vi, năng lực, tình trạng công việc. Đồng thời, đó là sự chia sẻ tình trạng của người khác dựa trên những quan sát khách quan và sự phân tích nhằm tăng cường, hỗ trợ, hướng dẫn lại cách thức thực hiện công việc cho người khác",
    level1: null,
    level2: null,
    level3: null,
    level4: null,
  ...
  },
  {
    ...
    level2:
      "- Áp dụng đúng quy trình xử lý vào công việc thực tế. \n-Có khả năng tổng hợp và hệ thống hoá được quy trình xử lý với khách hàng theo nhóm với mức chi phí cụ thể\n",
    level3:
    ...
    level4:
      "- Đánh giá được hiệu quả công việc của bản thận và các bộ phận liên quan trong công việc xử lý khiếu nại.  \n- Phân tích được những tình huống phát sinh trong trong công việc, đưa ra những cải tiến trong quy trình xử lý. ",
    level5:
  ...
  },
  {
    ...
    level5:
      "Có khả năng hướng dẫn được cho người mới về các công cụ quản lý chất lượng trên. \nĐưa ra những phương pháp mới để quản lý chất lượng hiệu quả. \nCó khả năng xử lý hiệu quả mọi tình huống phát sinh trong công việc. ",
  },
  {
    Source: null,
    group: "Knowledge",
